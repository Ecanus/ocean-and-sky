...
/// <summary>
/// GameWorld class is responsible for keeping track of the control settings and handling input
...
public class GameWall : MonoBehaviour {
	...
	void Start () {
		...
		/*
		P1 = GameObject.Find ("Player01").GetComponent<Player> ();
		P2 = GameObject.Find ("Player02").GetComponent<Player> ();
